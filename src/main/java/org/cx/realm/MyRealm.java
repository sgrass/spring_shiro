...
//    simpleAuthorInfo.addStringPermissions(permissionList);  
      ...
      }else if(null!=currentUsername && "temp".equals(currentUsername)){  
          System.out.println("当前用户[temp]无授权");  
          return simpleAuthorInfo;  
      }  
...
//    }  
      ...
      if("admin".equals(token.getUsername())){  
          ...
          return authcInfo;  
      }else if("temp".equals(token.getUsername())){  
          AuthenticationInfo authcInfo = new SimpleAuthenticationInfo("temp", "temp", this.getName());  
          this.setSession("currentUser", "temp");  
          return authcInfo;  
      }  
